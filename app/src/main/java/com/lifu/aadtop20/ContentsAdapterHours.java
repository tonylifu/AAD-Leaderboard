...
public class ContentsAdapterHours extends RecyclerView.Adapter<ContentsAdapterHours.ContentsViewHolder> implements Filterable {

    String TAG = getClass().getSimpleName();

    private TopLearnersFragment mParent;
    ...
    public ContentsAdapterHours(Context context, TopLearnersFragment mParent, ArrayList<SkillIqDTO> mContents){
    ...
    public ContentsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.item_list_card_hours, parent,false);
    ...
    public class ContentsViewHolder extends RecyclerView.ViewHolder{
        ...
        public ContentsViewHolder(@NonNull View itemView) {
            ...
            mTvName = (TextView)itemView.findViewById(R.id.tvName2);
            mTvScore = (TextView)itemView.findViewById(R.id.tvScore2);
            mTvCountry = (TextView)itemView.findViewById(R.id.tvCountry2);
            mIvImage = (ImageView)itemView.findViewById(R.id.ivImage2);
