...
import com.lifu.aadtop20.dto.SkillIQ;
 ...
 * Use the {@link TopIQFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TopIQFragment extends Fragment {
     ...
     * @return A new instance of fragment TopIQFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TopIQFragment newInstance(String param1, String param2) {
        TopIQFragment fragment = new TopIQFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_top_i_q, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mMainPbarRoll = (ProgressBar) mView.findViewById(R.id.mainPbarRoll);
        mTvMainPbar = (TextView) mView.findViewById(R.id.tvMainPbar);

        //mMainPbar.setVisibility(View.INVISIBLE);
        mMainPbarRoll.setVisibility(View.INVISIBLE);
        mTvMainPbar.setVisibility(View.INVISIBLE);

        mRecyclerView = (RecyclerView) mView.findViewById(R.id.item_list);
    ...
    private class LoadContent extends AsyncTask<String, Void, Object> {
        ...
        protected void onPostExecute(Object o) {
            ...
            SkillIqDTO[] contentsDTO = gson.fromJson(result, SkillIqDTO[].class);
            ...
            for(i = 0; i < contentSize; i++){
                ...
                content.score = contentsDTO[i].score;
            ...
            mContentsAdapter = new ContentsAdapter(mView.getContext(),TopIQFragment.this, mContents);
